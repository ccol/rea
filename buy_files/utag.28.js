//tealium universal tag - utag.28 ut4.0.201903120305, Copyright 2019 Tealium.com Inc. All Rights Reserved.
...
if(b['page.page_name']=='rea:homeloans:bridging'){b['event.krux_id']='MIXmSuAI';}
if(b['page.page_name']=='nab:online-conditional-approval:get-started'){b['event.krux_id']='MIXmdw6p';}
if(b['page.page_name']=='nab:online-conditional-approval:next-steps'){b['event.krux_id']='MIXm3mo6';}
if(b['page.page_name']=='nab:online-conditional-approval:Exit1'){b['event.krux_id']='MIXnF6by';}
if(b['page.page_name']=='nab:online-conditional-approval:Outcome'){b['event.krux_id']='MIXnPp1n';}
if(b['page.page_name']=='rea:my-finances:finances'){b['event.krux_id']='MIXo4iWp';}
